...
TARGET_REMOVE = ["resultado_hemo", "resultado_hemo_mo", "all_cult_org", "dominant_all_cult_org", "infected_yes_no", "bmr_etiologia", "fenotipo_resistencia", "fenotipo_resistencia_individual"]
